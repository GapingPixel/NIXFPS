...
void USMCharacterAttributeSet::OnRep_SanityLVL(const FGameplayAttributeData& OldSanityLVL)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(USMCharacterAttributeSet, SanityLVL, OldSanityLVL)
}
