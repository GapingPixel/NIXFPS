...
public:
	...
	USMAbilitySystemComponent* GetSMAbilitySystemComponentFromOwner() const;
...
protected:
	bool FindAbillityMeshMontage(const USkeletalMeshComponent* InMesh, FAbilityMeshMontage& InAbilityMontage);
